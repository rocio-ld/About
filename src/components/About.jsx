...
function About() {
  return (
    ...
    <h2 className="who">QUIÉNES SOMOS</h2>
    <div className="profile">
      <img className="profile__img" src="./images/foto1.jpeg" alt="Sandra" />
      <h3 className="name">Sandra Roldán Gómez</h3>
    ...
    <div className="profile">
      <img className="profile__img" src="./images/foto3.jpeg" alt="Shannon" />
      <h3 className="name">Shannon Evora Lopes Rodrigues</h3>
      <p className="description">
    ...
    <div className="profile">
      <img className="profile__img" src="./images/foto4.jpeg" alt="Anka" />
      <h3 className="name">Anka Georgiana Lucian</h3>
      <p className="description">
